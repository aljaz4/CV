document.addEventListener('DOMContentLoaded', function() {
 ...
 const translations = {
  sl: {
    ...
    skills1: "Timsko delo",
    skills2: "Komunikacija",
    skills3: "Reševanje problemov",
    skills4: "Učenje novih tehnologij",
  ...
  en: {
    ...
    skills1: "Teamwork",
    skills2: "Communication",
    skills3: "Problem solving",
    skills4: "Learning new technologies",
  ...
  de: {
    ...
    other_skills: "Andere Fähigkeiten",
        skills1: "Teamarbeit",
    skills2: "Communicatie",
    skills3: "Lösung von Problemen",
    skills4: "Erlernen neuer Technologien",
